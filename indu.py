...
DATA_FILE = os.path.join(current_dir, "datax.json")
...
def sync_with_github(reason="manual"):
    ...
    try:
        ...
        # GitHub API URL
        url = f"https://api.github.com/repos/{REPO_OWNER}/{REPO_NAME}/contents/datax.json"
...
def main_keyboard():
    ...
    kb.row(
        ...
        types.InlineKeyboardButton("👤 ADMIN", url="https://t.me/GauravPhilosopher_bot")
    )
    return kb
