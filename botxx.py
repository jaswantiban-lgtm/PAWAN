...
def handle_message(m):
    ...
    if text == "/start":
        ...
        bot.send_message(chat_id, f"🔁 Session refreshed. You have {current_credits} searches.", reply_markup=main_keyboard())
...
print("🔐 Session-based verification: ACTIVE")
